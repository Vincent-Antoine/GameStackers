 ...
 */
class getPlateformRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlateformRepository' shared autowired service.
     *
     * @return \App\Repository\PlateformRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlateformRepository.php';

        return $container->privates['App\\Repository\\PlateformRepository'] = new \App\Repository\PlateformRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
